            ...
            @foreach($locales as $code => $label)
                <div x-show="activeTab === '{{ $code }}'" x-cloak>
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            <x-input-label for="translations_{{ $code }}_slug" value="Slug" lang="{{ $code }}" />
                        ...
                        <div>
                            <x-input-label for="translations_{{ $code }}_curriculum_pdf_url" value="Curriculum PDF URL" lang="{{ $code }}" />
                        ...
                        <div>
                            <x-input-label for="translations_{{ $code }}_welcome_video_url" value="Welcome Video URL" lang="{{ $code }}" />
