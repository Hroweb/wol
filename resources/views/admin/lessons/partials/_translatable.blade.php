                        ...
                        <div class="md:col-span-2">
                            ...
                            @if(isset($lessonTranslationsData[$code]['materials']) && is_array($lessonTranslationsData[$code]['materials']) && !empty($lessonTranslationsData[$code]['materials']))
                                <div class="mb-3 p-3 bg-gray-50 dark:bg-gray-800 rounded-lg">
                                    <h4 class="text-xs font-medium text-gray-700 dark:text-gray-300 mb-2">Current Materials:</h4>
                                    @foreach($lessonTranslationsData[$code]['materials'] as $index => $file)
                                        <div class="flex items-center justify-between py-2 border-b border-gray-200 dark:border-gray-700 last:border-b-0">
                                            ...
                                            <div class="flex items-center space-x-2 justify-between w-30">
                                                <a href="{{ Storage::url($file['path']) }}" target="_blank" class="flex items-center dark:text-gray-400 text-xs gap-1">
                                                    <x-admin.svgs.eye-icon width="16" height="16" />
                                                    View
                                                </a>
                                                <button
                                                    type="button"
                            ...
                            />
                            <div class="mt-1 text-xs text-gray-500">Upload multiple PDF files (hold Ctrl/Cmd to select multiple)</div>
