<x-app-layout>
    ...
    <div class="customers-page admin-page">
        ...
        <div class="space-y-5 sm:space-y-6">
            ...
            <form action="{{ route('admin.pages.update', $page) }}" method="POST" x-data="{ slugManuallyEdited: false }" @generate-slug.window="if (!slugManuallyEdited) { const slug = window.generateSlugFromTitle($event.detail); if (slug) document.getElementById('slug').value = slug; }" @slug-manually-edited.window="slugManuallyEdited = true">
                @csrf
                @method('PUT')
