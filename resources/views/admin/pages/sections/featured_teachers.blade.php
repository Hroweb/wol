{{-- Featured Teachers Section: Settings + Translations --}}
...
<div class="space-y-4">
    ...
    <div class="p-6 bg-ghostwhite dark:bg-gray-dark">
        <div class="mb-3">
            <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Select Teachers</label>
            <select :name="`sections[${index}][settings][teacher_ids][]`" multiple
                    x-model="section.settings.teacher_ids"
            ...
            <p class="mt-1 text-xs text-gray-500">Hold Ctrl/Cmd to select multiple teachers</p>
        </div>
        <div class="mb-3">
            ...
            <input type="number" :name="`sections[${index}][settings][limit]`" x-model="section.settings.limit"
                   placeholder="6" min="1"
                   class="text-sm w-full rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-900 px-4 py-2.5 text-gray-900 dark:text-white">
            <p class="mt-1 text-xs text-gray-500">Maximum number of teachers to display</p>
        </div>
