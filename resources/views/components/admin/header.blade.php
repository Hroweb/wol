...
>
    <div class="w-full flex grow flex-col items-center justify-between lg:flex-row lg:px-6">
        ...
        <div
            ...
            class="w-full shadow-theme-md items-center justify-between gap-4 px-5 py-4 lg:flex lg:justify-end lg:px-0 lg:shadow-none"
        >
