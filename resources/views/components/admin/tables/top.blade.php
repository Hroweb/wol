...
<div class="flex flex-col justify-between gap-5 border-b border-gray-200 px-5 py-4 sm:flex-row sm:items-center dark:border-gray-800">
    ...
    @if($export || $addNew)
        <div class="flex gap-3">
            ...
            @endif
            @if($addNew)
                <a href="{{Route::has('admin.'.$page.'.create') ? route('admin.'.$page.'.create') : '#'}}" class="bg-blue-button shadow-theme-xs hover:bg-blue-button inline-flex items-center justify-center gap-2 rounded-lg px-4 py-3 text-sm font-medium text-white transition">
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
